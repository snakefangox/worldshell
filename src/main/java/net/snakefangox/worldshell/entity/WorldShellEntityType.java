 ...
 * no responsibility.
 */
public class WorldShellEntityType<T extends WorldShellEntity> extends EntityType<T> {
    ...
    public WorldShellEntityType(EntityFactory<T> factory, int maxTrackDistance, int trackTickInterval,
        ...
        super(factory, SpawnGroup.MISC, true, false, true, true, ImmutableSet.of(), EntityDimensions.changing(1, 1),
                maxTrackDistance, trackTickInterval, FeatureFlags.VANILLA_FEATURES);
    }
}
